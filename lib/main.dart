...
class _ReadWriteFileExampleState extends State<ReadWriteFileExample> {
  ...
  String _localFilePatch = kLocalFileName;
  ...
  void initState() {
    ...
    _getLocalFile
        .then((file) => setState(() => _localFilePatch = file.path));
  }
            ...
            children: <Widget>[
              MaterialButton(
                ...
                onPressed: () async {
                  ...
                  log('String successful loaded from local file');
                },
              ),
              MaterialButton(
                ...
                onPressed: () async {
                  ...
                  log('String successful write from local file');
                },
              ),
            ],
          ),
